...
JSON API definition.
API decorator
decorating the return value of the original function to JSON format
'''
...
def api(func):
	...
	Serialize the return value of the function to JSON format
	And take this JSON format data as return value
